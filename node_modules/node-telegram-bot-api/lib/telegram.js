...
var TelegramBot = function (_EventEmitter) {
  ...
  _createClass(TelegramBot, [{
    ...
    key: 'sendMessage',
    value: function sendMessage(chatId, text, keyboard) {
    var form = arguments.length <= 3 || arguments[2] === undefined ? {} : arguments[2];
      //value: function sendMessage(chatId, text, replyMarkup) {
